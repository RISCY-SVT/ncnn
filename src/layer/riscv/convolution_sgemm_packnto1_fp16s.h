...
static void im2col_sgemm_packnto1_fp16sa_rvv(const Mat& bottom_im2col, Mat& top_blob, const Mat& kernel, const Mat& _bias, const Option& opt)
{
...
#else
        const __fp16 zeros[packn] = {(__fp16)0};
#endif // __clang__
    ...
    for (int p = remain_outch_start; p < outch; p++)
    {
        ...
        const __fp16 bias0 = bias ? bias[p] : (__fp16)0;
        ...
        for (; i + 7 < size; i += 8)
        {
            ...
            vfloat16m1_t _sum0 = __riscv_vfmv_v_f_f16m1((__fp16)0, vl);
            vfloat16m1_t _sum1 = __riscv_vfmv_v_f_f16m1((__fp16)0, vl);
            vfloat16m1_t _sum2 = __riscv_vfmv_v_f_f16m1((__fp16)0, vl);
            vfloat16m1_t _sum3 = __riscv_vfmv_v_f_f16m1((__fp16)0, vl);
            vfloat16m1_t _sum4 = __riscv_vfmv_v_f_f16m1((__fp16)0, vl);
            vfloat16m1_t _sum5 = __riscv_vfmv_v_f_f16m1((__fp16)0, vl);
            vfloat16m1_t _sum6 = __riscv_vfmv_v_f_f16m1((__fp16)0, vl);
            vfloat16m1_t _sum7 = __riscv_vfmv_v_f_f16m1((__fp16)0, vl);
